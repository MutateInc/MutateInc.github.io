# ES03-Estandar de creación de proceso
...
| Formalización | Acudir a los recursos necesarios para formalizar el proceso y redactar siguiendo la [plantilla de proceso](../Plantillas/PL05.md) y, si es necesario, la [guía de creación de procesos](../Guias/GU01.md), tomando como base el [proceso de institucionalización de assets](../Procesos/PR03.md) para que pueda ser validada correctamente | Responsables del proceso | --         |
