...
<tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li>Subir el asset al repositorio siguiendo los <a href="../Estandares/ES01">estándares de nombramiento de ramas</a>, <a href="../Estandares/ES02">estándares de mensajes de commits</a> y <a href="../Estandares/ES03">estándares de pull requests</a>.</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Completar el pull request siguiendo los <a href="../Estandares/ES03">estándares de pull requests</a>. Mencionado anteriormente, para poder visualizar el asset ya verificado en la Wiki de Mutate.</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> Comunicar la creación exitosa del asset a travéz de los canales de Discord para empezar a implementarlo en la forma de trabajo, incluyendo el objetivo del asset y sus salidas, así para cubrir con lo mínimo de un release del asset</li>
        </ul>
      </td>
      <td>Equipo de validación</td>
      <td>
