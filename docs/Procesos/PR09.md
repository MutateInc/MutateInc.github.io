...
- Propuesta/borrador de asset para el departamento, siguiendo la [guía para definición de assets](https://mutateinc.github.io/docs/Guias/GU08).
...
<tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li>Desarrollar el contenido del asset siguiendo la plantilla correspondiente, para un mayor entendimiento revisar las definiciones de assets (<a href="../Definiciones/DE06">procesos</a>, <a href="../Definiciones/DE07">guías</a>, <a href="../Definiciones/DE08">plantillas</a>, <a href="../Definiciones/DE09">políticas</a>) .</li>
            ...
            <li>Subir el asset al repositorio siguiendo los <a href="../Estandares/ES01">estándares de nombramiento de ramas</a>, <a href="../Estandares/ES02">estándares de mensajes de commits</a> y <a href="../Estandares/ES03">estandares de pull requests</a>.</li>
      ...
      <td>
        <ul>
          ...
          <ul>
            ...
            <li>Duplicar la checklist de codigo en la misma plantilla agregando la tabla a la parte inferior de la tabla que se evaluó, actualizar el valor de la versión agregando un incremento, esto para asegurar las observaciones realizadas a lo largo de la gestion de cada asset</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Completar el pull request siguiendo los <a href="../Estandares/ES03">estandares de pull requests</a>. Mencionado anteriormente, para poder visualizar el asset ya verificado en la wiki de Mutate.</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            <li> Comunicar la creación exitosa del asset a travez de los canales de discord para empezar a implementarlo en la forma de trabajo, inlcuyendo el objetivo del asset y sus salidas, así para cubrir con lo mínimo de un release del asset</li>
        </ul>
      </td>
      <td>Equipo de validación</td>
      <td>
