...
<tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            ...
            <li>Subir el asset al repositorio siguiendo la <a href="https://mutateinc.github.io/docs/Politicas/PO03">política de pull requests</a>.</li>
     ...
     <tr>
      ...
      <td>
        <ul>
          ...
          <li>Verificar que el asset cumple con todos y cada uno de los elementos definidos en la <a href="https://docs.google.com/spreadsheets/d/1FzfJd_yahKMj8yLV8VuqbcArkBtyAe5-AVvSRLDyzM8/edit#gid=0">auditoría </a> .</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Completar el pull request siguiendo la <a href="https://mutateinc.github.io/docs/Politicas/PO03">política de pull requests</a>. mencionada anteriormente, para poder visualizar el asset ya verificado en la wiki de Mutate.</li>
