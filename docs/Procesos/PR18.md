...
<tbody>
   ...
   <li>
    ...
    <tr>
      ...
      <td>
        <ul>
        <li>Duplicar la plantilla en una nueva hoja dentro del <a href="https://docs.google.com/spreadsheets/d/192q0Kr6SXPhVP6r-YdDrpQuUWCu5zjq-/edit#rangeid=1823258566">Reporte de Evaluación de Decisión</a>
        </li>
        <li>
...
Recolectar y documentar todas las posibles alternativas.
    ...
    <tr>
      ...
      <li>
        Aplicación del 
        <a href="https://docs.google.com/spreadsheets/d/192q0Kr6SXPhVP6r-YdDrpQuUWCu5zjq-/edit#rangeid=1633114623"> método de evaluación seleccionado.</a>
      </li>
      <li>
