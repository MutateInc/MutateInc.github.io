...
| Formalización | Acudir a los recursos necesarios para formalizar el proceso y redactar siguiendo la [plantilla de proceso](../Plantillas/Proceso.md) y, si es necesario, la [guía de creación de procesos](../Guias/CreacionDeProceso.md), tomando como base el [proceso de institucionalización de assets](../Procesos/InstitucionalizacionAssets.md) para que pueda ser validada correctamente | Responsables del proceso | --         |
